			...
			<article className={a.article} aria-labelledby="accessibility-statement-title">
				...
				<LegalList>
					...
					<li>
						...
						responsibilities assigned to team members across the organisation. These roles ensure that accessibility is a
						continuous priority.
					</li>
					<li>
				...
				<p>
					The{" "}
					<abbr title="Web Content Accessibility Guidelines">WCAG</abbr> define requirements for improving accessibility for
					people with disabilities, with three levels of conformance: Level A, Level AA, and Level AAA. ivvi&apos;s products
					and services are partially conformant with WCAG 2.1 Level AA. This means that while we strive for full compliance,
					some aspects of our content may not fully meet these standards.
				</p>
				<p>
					Additionally, although ivvi is not required to conform to Section 508 of the Rehabilitation Act (which applies to{" "}
					<abbr title="United States">US</abbr> federal agencies), we use it as guidance to enhance the accessibility of our
				...
				<p>
					...
					contact us at{" "}
					<LegalA href="mailto:support@ivvi.app">support@ivvi.app</LegalA>. We strive to respond to feedback within 24 hours.
				</p>
				...
				<p>
					...
					application is optimised for use with Chrome and Edge browsers.
				</p>

				<LegalH2 id="a11y-limitations">6. Limitations and Alternatives</LegalH2>
				<p>
					While we are committed to ensuring the accessibility of our products, we recognise that there are areas where we can
				...
				<LegalList>
					...
					<li>
						...
						optimised for accessibility. We are actively collaborating with our third-party providers to enhance the
					...
					<li>
						...
						<kbd className={a.kbd}>Space</kbd> to interact with the content in Focus Mode. We are looking for ways to simplify
						this interaction.
					</li>
				</LegalList>
				...
				<p>
					For any accessibility-related queries or feedback, please contact us at{" "}
					<LegalA href="mailto:support@ivvi.app">support@ivvi.app</LegalA>. We are here to help and ensure that our products meet
					your needs.
				</p>
			</article>
		</LegalPage>
